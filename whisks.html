...
<html lang="en">
    <head>
        ...
        <title>Matchaverse | Matcha Powders</title>
        <!-- Css Link -->
        <link rel="stylesheet" href="style.css">
    
        <!-- Tab bar logo -->
        <link rel="icon" href="photos/mug.jpg">
    ...
    <body>
        <header> 
            ...
            <div class="nav-icon">
                ...
                <a href="account.html"><i class='bx bx-cart'></i></a>
        ...
        <header class="header2"> 
            ...
            <ul class=" categories">
                ...
                <li><a href="#"  >Matcha Powders</a></li>
                <li><a href="#"class="pactive"  >Whisks</a></li>
                <li><a href="delivery.html">Mugs/Glasses</a></li>
                <li><a href="giftcards.html">Coasters</a></li>
                <li><a href="giftcards.html">Spoons</a></li>
                <li><a href="giftcards.html">Plates</a></li>
                <li><a href="giftcards.html">Straws</a></li>
...
<!-- Footer -->
    <section class="contact">
        ...
        <div class="second-info">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam a dignissimos velit facere commodi? <br>Ea nulla necessitatibus perspiciatis soluta, culpa pariatur qui autem accusantium? Dignissimos nam sit molestias animi exercitationem.</p>
        </div>
    ...
    <hr>
        <p class="copyright">Copyright 2023 - MATCHAVERSE</p>
    </section>
